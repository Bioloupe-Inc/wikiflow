...
This map describes WikiFlow's available skills. The wiki-driven replacement workflow is still in design; route through the current skills below.
...
**`/setup-wikiflow`**: run before your first engineering flow to configure the issue tracker, triage labels, and doc layout the other skills assume. Custom issue trackers also work.
