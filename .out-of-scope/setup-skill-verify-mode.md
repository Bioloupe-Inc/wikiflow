# Verify/Check Mode for `setup-wikiflow`

This project will not add a dedicated verify/check mode (or a separate verify skill) for `setup-wikiflow`.
...
- #106: Feature request: verify/check mode for setup-wikiflow
