...
| Nothing is written yet and you want it written test-first | [tdd](https://github.com/Bioloupe-Inc/wikiflow/blob/main/docs/engineering/tdd.md) |
| A whole spec needs building, review included | [implement](https://github.com/Bioloupe-Inc/wikiflow/blob/main/docs/engineering/implement.md), which calls this skill itself |
| The whole codebase has drifted, not one diff | [improve-codebase-architecture](https://github.com/Bioloupe-Inc/wikiflow/blob/main/docs/engineering/improve-codebase-architecture.md) |
| Something is broken and you do not know why | [diagnosing-bugs](https://github.com/Bioloupe-Inc/wikiflow/blob/main/docs/engineering/diagnosing-bugs.md) |
...
Step 1 depends on `docs/agents/issue-tracker.md`, which [setup-wikiflow](https://github.com/Bioloupe-Inc/wikiflow/blob/main/docs/engineering/setup-wikiflow.md) writes. Without it the axis still works if you hand it a path. With no spec at all, the Spec sub-agent is skipped and the report says "no spec available" rather than inventing requirements.
...
- [implement](https://github.com/Bioloupe-Inc/wikiflow/blob/main/docs/engineering/implement.md) is the closest neighbour: it drives the build and calls this skill as its own closing review before committing.
- [to-spec](https://github.com/Bioloupe-Inc/wikiflow/blob/main/docs/engineering/to-spec.md) and [to-tickets](https://github.com/Bioloupe-Inc/wikiflow/blob/main/docs/engineering/to-tickets.md) produce the document the Spec axis checks against; a vague spec makes that axis vague.
- [improve-codebase-architecture](https://github.com/Bioloupe-Inc/wikiflow/blob/main/docs/engineering/improve-codebase-architecture.md) is the whole-codebase counterpart: this skill only ever looks at one diff.

[ask-wikiflow](https://github.com/Bioloupe-Inc/wikiflow/blob/main/docs/engineering/ask-wikiflow.md) routes across the whole set when you are unsure which skill the situation wants.
